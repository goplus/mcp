...
//line demo/resource/readme_res.gox:3
...
//line demo/resource/readme_res.gox:8:1
		if _gop_err != nil {
//line demo/resource/readme_res.gox:8:1
			_gop_err = errors.NewFrame(_gop_err, "os.readFile(\"README.md\")", "demo/resource/readme_res.gox", 8, "main.Main")
//line demo/resource/readme_res.gox:8:1
			panic(_gop_err)
		}
//line demo/resource/readme_res.gox:8:1
...
//line demo/resource/user_profile_res.gox:1:1
...
//line demo/resource/user_profile_res.gox:6
...
//line demo/resource/user_profile_res.gox:3:1
	this.ResourceApp.Main(_gop_arg0, _gop_arg1, _gop_arg2)
//line demo/resource/user_profile_res.gox:6:1
	this.Resource("users://{id}/profile", "User Profile", func() {
//line demo/resource/user_profile_res.gox:7:1
		this.Description("Returns user profile information")
//line demo/resource/user_profile_res.gox:8:1
...
//line demo/resource/user_profile_res.gox:12:1
	if !ok {
//line demo/resource/user_profile_res.gox:13:1
...
//line demo/resource/user_profile_res.gox:16:1
		if _gop_err != nil {
//line demo/resource/user_profile_res.gox:16:1
			_gop_err = errors.NewFrame(_gop_err, "getUserProfile(userID)", "demo/resource/user_profile_res.gox", 16, "main.Main")
//line demo/resource/user_profile_res.gox:16:1
			panic(_gop_err)
		}
//line demo/resource/user_profile_res.gox:16:1
...
//line demo/resource/user_profile_res.gox:18:1
