...
func (this *MCPApp) Main() {
	server.Gopt_MCPApp_Main(this, []server.ToolProto{new(calc)})
}
//line demo/calc/calc_tool.gox:1
func (this *calc) Main(_gop_arg0 context.Context, _gop_arg1 mcp.CallToolRequest, _gop_arg2 *server.ToolAppProto) *mcp.CallToolResult {
